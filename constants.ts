...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: MenuId.PARKING_CHECK, label: '주차/실외기', subItems: ['지정주차차량현황', '지정주차변경이력', '지정주차차량위치'] },
  { id: MenuId.EQUIPMENT_HISTORY, label: '장비이력카드' },
