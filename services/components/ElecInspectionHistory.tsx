    ...
    if (item.tabId === 'generator') {
      ...
      contentHtml = `
        ...
        ${['rectifier', 'battery', 'generator'].map(section => {
          const label = section === 'rectifier' ? '1. 정류기반' : section === 'battery' ? '2. 개별전류' : '3. 발전기';
          ...
          <table className="w-full min-w-[750px] border-collapse">
            <thead>
              <tr className="bg-white h-[40px]">
                ...
                <th className="border-b border-r border-black text-center text-[13px] font-normal text-black w-56 p-0"><div className="flex items-center justify-center h-full px-2">상세보기</div></th>
              </tr>
            </thead>
            <tbody>
                      ...
                      <td className="border-b border-r border-black p-0 text-center">
                        <div className="flex items-center justify-center gap-2 h-full px-2">
                          <button 
                            ...
                            className="flex items-center gap-1 bg-blue-600 text-white px-3 py-1 rounded text-[11px] font-normal hover:bg-blue-700 transition-all active:scale-95"
                          >
                            상세보기
                            <Printer size={12} />
                          </button>
