...
import { ElevatorInspectionItem } from '../types';
import { fetchElevatorInspectionList } from '../services/dataService';
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-4 animate-fade-in">
      <div className="flex justify-between items-center bg-white p-4 rounded-lg shadow-sm border border-gray-200">
        <div className="flex items-center space-x-2">
          <h2 className="text-xl font-bold text-gray-800">승강기 점검 이력 리스트</h2>
        </div>
      </div>
