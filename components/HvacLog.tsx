...
const HvacLog: React.FC<HvacLogProps> = ({ currentDate, isEmbedded = false, onUsageChange }) => {
  ...
  }, [dateKey, currentDate, applyCalculations]);
        ...
        <head>
          ...
          <style>
            ...
            @media print {
              ...
              th, td { border: 1px solid black !important; text-align: center !important; height: 24px !important; color: black !important; padding: 0px !important; line-height: 1.0 !important; }
